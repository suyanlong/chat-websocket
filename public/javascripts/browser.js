/**
 * WebSocket 的学习。
 * 1、似乎不能运行，使用这个文件的时候，了解WebSocket的协议规范，才能进行开发。
 * 2、
 */
...
$(
    function () {
      ...
      //  WebSocket = require('ws');
        ...
        //var connection = new WebSocket(window.location.href);
      ...
      //  connection.bufferedAmount
        ...
        function addMessage(author, message, color, dt) {
            content.append('<p><span style="color:' + color + '">' + author + '</span> @ ' + +dt.getHours() + ':'
